...
<head>
    ...
    <title>Acapella - O melhor do RAP</title>
</head>
<body>
    <header>
        <div class="menu_side">
        ...
        <div class="song_side">
            ...
            <div class="popular_artists">
                ...
                <div class="item Artists_bx">
                     <li>
                        <img src="img_rap/eminem.jpg" alt="Eminem" title="Eminem" >
                    </li>
                    <li>
                        <img src="img_rap/traviss.jpg" alt="Travis Scott" title="Travis Scott" >
                    </li>
                    <li>
                        <img src="img_rap/jcole.jpg" alt="J. Cole" title="J. Cole" >
                    </li>
                    <li>
                        <img src="img_rap/drake.jpg" alt="Drake" title="Drake" >
                    </li>
                    <li>
                        <img src="img_rap/matue.jpg" alt="Matuê" title="Matuê" >
                    </li>
                    <li>
                        <img src="img_rap/kl.jpg" alt="Kendrick Lamar" title="Kendrick Lamar" >
                    </li>
                    <li>
                        <img src="img_rap/future.jpg" alt="Future" title="Future" >
                    </li>
                    <li>
                        <img src="img_rap/chrisbrown.jpg" alt="Chris Brown" title="Chris Brown" >
                    </li>
                    <li>
                        <img src="img_rap/21savage.jpg" alt="21 Savage" title="21 Savage" >
                    </li>
                    <li>
                        <img src="img_rap/jayz.jpg" alt="Jay Z" title="Jay Z" >
                    </li>
                    <li>
                        <img src="img_rap/dave.jpg" alt="Dave" title="Dave" >
                    </li>
                    <li>
                        <img src="img_rap/liluzivert.jpg" alt="Lil Uzi Vert" title="Lil Uzi Vert" >
                    </li>
                    <li>
                        <img src="img_rap/2pac.jpg" alt="2Pac" title="2Pac">
                    </li>
                    <li>
                        <img src="img_rap/biggie.jpg" alt="Biggie Smalls" title="Biggie Smalls" >
                    </li>
                    <li>
                        <img src="img_rap/eazye.jpg" alt="Eazy-E" title="Eazy-E" >
                    </li>
                </div>
            </div>
        </div>
