...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style-podcasts.css">
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <h2>Podpah - </h2>
                <p>
                    O Podcast do momento<br> da lingua portuguesa
                </p>
            </div>

            <div class="popular_song">
                <div class="h4">
                    <h4>Podcasts do momento</h4>
                    <div class="btn_s">
                ...
                <div class="pop_song">
                    <li class="songItem">
                        <div class="img_play">
                            <img src="img/here with me.jpg" alt="d4vd">
