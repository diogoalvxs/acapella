...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="joji.css">
    ...
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <h1>Joji</h1>
                <p>
                    Joji é um cantor, rapper e compositor japonês 
                    <br>
                    O seu estilo é descrito prinpipalmente como um mix de
                    <br>
                    R&B, lo-fi e trip Hop
                    <br>
                    <b>30 229 788 ouvintes mensais</b>
                </p>
                <div class="buttons">
            ...
            <div class="popular_artists">
                ...
                <div class="pop_song">
                    <a href="oldies.php"><li class="songItem">
                        <div class="img_play">
                            <img src="img_joji/11.jpg" alt="SMITHEREENS" title="SMITHEREENS">
                            <i class="" id="10"></i>
                        </div>
                        <h5>
                        SMITHEREENS <br>
                        <div class="subtitle">Últimos lançamentos</div>
                    </h5>
                    </li>
                </a>
                    <a href="#"><li class="songItem">
                        <div class="img_play">
                            <img src="img_joji/13.jpg" alt="Nectar" title="Nectar">
                        </div>
                        <h5>
                        Nectar <br>
                    ...
                    <a href="rap.php"><li class="songItem">
                        <div class="img_play">
                            <img src="img_joji/12.jpg" alt="BALLADS 1" title="BALLADS 1">
                            <i class="" id="11"></i>
                        </div>
                        <h5>
                        BALLADS 1 <br>
                    ...
                    <a href="#"><li class="songItem">
                        <div class="img_play">
                            <img src="img_joji/15.jpg" alt="In Tongues (Deluxe)" title="In Tongues (Deluxe)">
                        </div>
                        <h5>
                        In Tongues (Deluxe) <br>
                        <div class="subtitle">2018</div>
                    </h5>
                    </li>
                </a>
